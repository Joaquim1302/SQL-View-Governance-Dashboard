...
def run_nexus_views_deploy(config_db, log_callback=print):
    """
    Filtra as views do create_nexus_views_manifests.json, lê os arquivos .sql do repositório Git
    ...
    try:
        ...
        log_callback(f"[ERRO] Falha ao parsear o create_nexus_views_manifests.json: {e}")
        return False
    ...
    for item in manifest:
        ...
        db_name = item.get("database", "nexus")
...
if __name__ == "__main__":
    ...
    run_nexus_views_deploy(db_test)
